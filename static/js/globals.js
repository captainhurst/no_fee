...
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  function sameHeight(selector){
    if($(window).width() < 992){
      var $toAlign = $(selector);
      $toAlign.height('auto');
      var componentHeights = $toAlign.map(function(i, e){
        return $(e).height();
      });
        var max = Math.max.apply(Math, componentHeights );
        $toAlign.height(max+"px");
      }else{
        var $toAlign = $(selector);
        $toAlign.height('auto');
      }
