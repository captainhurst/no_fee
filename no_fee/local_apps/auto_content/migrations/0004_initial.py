...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'auto_content_extractedarticle', (
            ...
            ('TweetImage', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('ArticleText', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('ArticleImage', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ...
            ('ParentCategory', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['articles.Category'], null=True, blank=True)),
            ('Slug', self.gf('django.db.models.fields.SlugField')(default=None, max_length=255, null=True, blank=True)),
            ('StoryArc', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['articles.StoryArc'], null=True, blank=True)),
        ))
