...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtractedArticle.Type'
        db.add_column(u'auto_content_extractedarticle', 'Type',
                      self.gf('django.db.models.fields.CharField')(default='extracted', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtractedArticle.Type'
        db.delete_column(u'auto_content_extractedarticle', 'Type')
    ...
    models = {
        ...
        u'auto_content.extractedarticle': {
            ...
            'Type': ('django.db.models.fields.CharField', [], {'default': "'extracted'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isLive': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
