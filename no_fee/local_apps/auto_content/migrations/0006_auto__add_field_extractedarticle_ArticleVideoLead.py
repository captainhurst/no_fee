...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtractedArticle.ArticleVideoLead'
        db.add_column(u'auto_content_extractedarticle', 'ArticleVideoLead',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtractedArticle.ArticleVideoLead'
        db.delete_column(u'auto_content_extractedarticle', 'ArticleVideoLead')
