...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtractedArticle.StoryArc'
        db.add_column(u'auto_content_extractedarticle', 'StoryArc',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['articles.StoryArc'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtractedArticle.StoryArc'
        db.delete_column(u'auto_content_extractedarticle', 'StoryArc_id')
