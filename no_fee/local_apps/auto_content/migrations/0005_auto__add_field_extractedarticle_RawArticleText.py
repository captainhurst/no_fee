...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtractedArticle.RawArticleText'
        db.add_column(u'auto_content_extractedarticle', 'RawArticleText',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtractedArticle.RawArticleText'
        db.delete_column(u'auto_content_extractedarticle', 'RawArticleText')
