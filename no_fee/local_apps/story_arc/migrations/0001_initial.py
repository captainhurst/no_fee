...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'story_arc_storyarc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('StoryAuthor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ...
            ('StoryTitle', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('StoryDescription', self.gf('django.db.models.fields.TextField')(default=None, max_length=300, null=True, blank=True)),
            ('StorySubtitle', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True)),
            ('StoryText', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('StoryMedia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.ArticleMedia'])),
            ('ParentCategory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.ParentCategory'])),
            ('StorySlug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
        ))
        db.send_create_signal(u'story_arc', ['StoryArc'])

        # Adding M2M table for field FeaturedProducts on 'StoryArc'
        m2m_table_name = db.shorten_name(u'story_arc_storyarc_FeaturedProducts')
        ...
        db.create_unique(m2m_table_name, ['storyarc_id', 'featuredproduct_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'story_arc_storyarc')

        # Removing M2M table for field FeaturedProducts on 'StoryArc'
        db.delete_table(db.shorten_name(u'story_arc_storyarc_FeaturedProducts'))
    ...
    models = {
        ...
        u'story_arc.storyarc': {
            'ChildStories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['articles.Article']", 'symmetrical': 'False'}),
            'DraftTime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'FeaturedProducts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['articles.FeaturedProduct']", 'symmetrical': 'False'}),
