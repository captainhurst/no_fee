...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleMedia.ArticleMediaName'
        db.add_column(u'articles_articlemedia', 'ArticleMediaName',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleMedia.ArticleMediaName'
        db.delete_column(u'articles_articlemedia', 'ArticleMediaName')
