...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.MetaCategoryDescription'
        db.add_column(u'articles_category', 'MetaCategoryDescription',
                      self.gf('django.db.models.fields.TextField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.MetaCategoryPageTitle'
        db.add_column(u'articles_category', 'MetaCategoryPageTitle',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Category.CategorySlug'
        db.alter_column(u'articles_category', 'CategorySlug', self.gf('django.db.models.fields.SlugField')(max_length=40))

    def backwards(self, orm):
        # Deleting field 'Category.MetaCategoryDescription'
        db.delete_column(u'articles_category', 'MetaCategoryDescription')

        # Deleting field 'Category.MetaCategoryPageTitle'
        db.delete_column(u'articles_category', 'MetaCategoryPageTitle')


        # Changing field 'Category.CategorySlug'
        db.alter_column(u'articles_category', 'CategorySlug', self.gf('django.db.models.fields.SlugField')(max_length=20))
